...
public class KurrentProjectionsFactoryTests
{
    IProjectionsFactory ProjectionsFactory;

    public KurrentProjectionsFactoryTests()
    {

        var services = CreateServiceCollection();
        var prov = services.BuildServiceProvider();
        ProjectionsFactory = prov.GetRequiredService<IProjectionsFactory>();
        new KurrentDataGenerator().WriteTestEventsToStore(10).Wait();
    }
        ...
        static ServiceCollection CreateServiceCollection()
        {
            ...
            services.AddTransient<ISubscriptionFactory, KurrentSubscriptionFactory>();
