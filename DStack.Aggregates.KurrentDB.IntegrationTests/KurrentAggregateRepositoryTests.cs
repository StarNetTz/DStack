...
namespace DStack.Aggregates.KurrentDB.IntegrationFacts;

public class KurrentAggregateRepositoryTests : IClassFixture<DatabaseFixture>
{
    DatabaseFixture Fixture;

    public KurrentAggregateRepositoryTests(DatabaseFixture fixture)
    {
        Fixture = fixture;
    }
...
{
    public KurrentAggregateRepository Repository;
    ...
    public DatabaseFixture()
    {
        ...
        Repository = new KurrentAggregateRepository(client);
    }
}
