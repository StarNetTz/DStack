...
public class KurrentSubscription : ISubscription
{
    const string EventClrTypeHeader = "EventClrTypeName";

    readonly ILogger<KurrentSubscription> Logger;
    ...
    public KurrentSubscription(ILogger<KurrentSubscription> logger, KurrentDBClient client)
    {
        Logger = logger;
        Client = client;
    }
